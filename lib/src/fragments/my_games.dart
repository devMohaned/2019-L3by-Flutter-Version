...
class MyGamesScreen extends StatelessWidget {
  ...
  MyGamesScreen(this.firebase_uid);

  @override
  Widget build(BuildContext context) {
    MyGamesBloc _bloc = MyGamesProvider.of(context);
    return buildList(_bloc);
  }

  Widget buildList(MyGamesBloc bloc) {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return new Dismissible(
                                ...
                                onDismissed: (direction) =>
                                    bloc.removeGame(streamedGames, game, context),
